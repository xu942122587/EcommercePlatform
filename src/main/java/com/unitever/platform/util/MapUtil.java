...
public class MapUtil {
	...
	/**
	 * 在Map&ltK,List&ltT>>中获取List&ltT>集合，如果集合不存在（null）则会创建ArrayList&ltT>并放在Map&
	 * ltK,List&ltT>>中
	 * 
	 * @param map
	 * @param key
	...
	/**
	 * 在Map&ltK1, Map&ltK2, T>>中获取Map&ltK2, T>，如果不存在（null）则会创建HashMap&ltK2,
	 * T>并放入Map&ltK1, Map&ltK2, T>>中
	 * 
	 * @param map
	 *            Map&ltK1, Map&ltK2, T>>
	 * @param key
	...
	/**
	 * 在Map&ltK1, Map&ltK2, Map&ltK3, T>>>中获取Map&ltK2, Map&ltK3,
	 * T>>，如果不存在（null）则会创建HashMap&ltK2, Map&ltK3, T>>并放入Map&ltK1, Map&ltK2,
	 * Map&ltK3, T>>>中
	 * 
	 * @param map
	...
	/**
	 * 在Map&ltK1, Map&ltK2, Map&ltK3, Map&ltK4, T>>>>中获取Map&ltK2, Map&ltK3,
	 * Map&ltK4, T>>>，如果不存在（null）则会创建HashMap&ltK2, Map&ltK3, Map&ltK4,
	 * T>>>并放入Map&ltK1, Map&ltK2, Map&ltK3, Map&ltK4, T>>>>中
	 * 
	 * @param map
	 ...
	 */
	public static <T, K1, K2, K3, K4> Map<K2, Map<K3, Map<K4, T>>> getMapMapMapInMap(
			Map<K1, Map<K2, Map<K3, Map<K4, T>>>> map, K1 key) {
	...
	/**
	 * 在Map&ltK1, Map&ltK2, Map&ltK3, Map&ltK4,
	 * String>>>>中获取Value，若Value为null则返回空字符串（""）
	 * 
	 * @param map
	 ...
	 * @return
	 */
	public static <K1, K2, K3, K4> String getValue(Map<K1, Map<K2, Map<K3, Map<K4, String>>>> map, K1 key1, K2 key2,
			K3 key3, K4 key4) {
		if (map.containsKey(key1) && map.get(key1) != null) {
