...
public class FileUtil {
	 ...
	 * @throws IOException
	 */
	public static void bindFile(String fileName, String filePath) throws IOException {
		File sourceFile = new File(getTempDir() + fileName);
		String targetFilePath = filePath + "/" + fileName;
	...
	public static void download(File file, String sourceName) {
		...
		try {
			...
			response.addHeader("Content-Disposition",
					"attachment;filename=" + new String(sourceName.getBytes(charsetName), "iso8859-1"));
			...
			if (start != 0) {
				...
				String contentRange = "bytes " + new Long(start).toString() + "-" + new Long(end - 1).toString() + "/"
