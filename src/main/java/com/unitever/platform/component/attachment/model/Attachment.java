...
public class Attachment implements Serializable {
	...
	public Attachment(String id, String id_owner, String path, String sourceFilename, String serverFilename,
			Integer fileNum, String fileSize, String fileKind, String status, String configCode) {
		super();
		this.id = id;
