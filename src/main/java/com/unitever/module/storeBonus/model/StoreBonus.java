package com.unitever.module.storeBonus.model;
 ...
 * @date 2017年8月10日
 */
public class StoreBonus extends BaseModel {
	/** Id */
	private String id;
	/**
	 * 商家店销售额
	 ...
	 *            创建时间
	 */
	public StoreBonus(String id, String startMoney, String proportion, String remark, Date createTime) {
		super();
		this.id = id;
