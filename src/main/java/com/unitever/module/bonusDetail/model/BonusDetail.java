package com.unitever.module.bonusDetail.model;
 ...
 * @date 2017年8月9日
 */
public class BonusDetail extends BaseModel {
	/** Id */
	private String id;
	/** 用户 */
	 ...
	 * @param id
	 */
	public BonusDetail(String id) {
		super();
		this.id = id;
	}

	public BonusDetail(String id, User guideUser, String targetMoney, String money, String month, String isPayMoney,
			Date createTime) {
		super();
		this.id = id;
