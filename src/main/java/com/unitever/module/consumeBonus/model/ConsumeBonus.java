package com.unitever.module.consumeBonus.model;
 ...
 * @date 2017年8月10日
 */
public class ConsumeBonus extends BaseModel {
	/** Id */
	private String id;
	/**
	 * 提成档位
	 ...
	 *            创建时间
	 */
	public ConsumeBonus(String id, String startMoney, String proportion, String remark, Date createTime) {
		super();
		this.id = id;
