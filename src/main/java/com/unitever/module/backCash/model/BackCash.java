package com.unitever.module.backCash.model;
 ...
 *
 * <P>
 * platform-tianhe->com.unitever.module.backCash.model->BackCash.java
 * </p>
 * <P>
 * 充值返现比例
 * </p>
 ...
 * @date 2017年8月5日
 */
public class BackCash extends BaseModel {
	/** Id */
	private String id;
	/**
	 * 提成档位
	 ...
	 *            创建时间
	 */
	public BackCash(String id, String startMoney, String proportion, String remark, Date createTime) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BackCash [id=" + id + ", startMoney=" + startMoney + ", proportion=" + proportion + ", remark="
