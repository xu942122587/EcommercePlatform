...
<script>
	var isSuccess = true;
	Namespace.register("com.yunt.storeBonus.input");
	com.yunt.storeBonus.input = {
		submitstoreBonus : function() {
			if ($('#theForm').data('bootstrapValidator').isValid()) {
				...
				if (isSuccess) {
					$.ajax({
						url : "${path}/storeBonus/saveOrUpdate",
						data : formData,
						type : "POST",
						async : false,
						dataType : "json",
...
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="display">
				<form onsubmit="return com.yunt.storeBonus.input.submitstoreBonus()"
