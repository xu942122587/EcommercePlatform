...
<script>
	var isSuccess = true;
	Namespace.register("com.yunt.registerBonus.input");
	com.yunt.registerBonus.input = {
		submitregisterBonus : function() {
			if ($('#theForm').data('bootstrapValidator').isValid()) {
				...
				if (isSuccess) {
					$.ajax({
						url : "${path}/registerBonus/saveOrUpdate",
						data : formData,
						type : "POST",
						async : false,
						dataType : "json",
...
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="display">
				<form onsubmit="return com.yunt.registerBonus.input.submitregisterBonus()"
					...
					<div class="form-group">
						<label for="product-uuid"
							class="col-xs-12 control-label lantiao_lable">注册提成设置信息</label>
					</div>

					<div class="form-group">
						<label for="product-uuid" class="col-xs-2 control-label">注册提成档位</label>
						<div class="col-xs-8">
