...
/* 			body {
		...
		<div>
			<div class="print_title_font_size">赔偿单号:${model.code }</div>
		</div>
		<div>
		...
		<div>
			<div class="print_title_font_size"style="text-align: center;margin-bottom: 10px;font-weight: bolder;font-size: 14px;">赔偿商品</div>
		</div>
		...
		<div>
			<div class="print_center print_title_font_size">赔偿金额:</div>
