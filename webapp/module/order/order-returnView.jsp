		...
		<div class="col-xs-12">
			<div class="display">
				...
				<div class="form-group">
					<label for="product-uuid" class="col-xs-12 control-label lantiao_lable">退货单信息</label>
				</div>
				<div class="form-group">
					<label for="product-uuid" class="col-xs-2 control-label">退货单号</label>
				...
				<div class="form-group">
					<label for="product-uuid" class="col-xs-2 control-label">现金应退</label>
					<div class="col-xs-3" style="padding-top: 7px;">
						<c:if test="${empty model.returnMoney}">
							0.0
						</c:if>
						<c:if test="${not empty model.returnMoney}">
							${model.returnMoney }
						</c:if>
					</div>
					
					<label for="product-uuid" class="col-xs-2 control-label">微信支付已退</label>
					<div class="col-xs-3" style="padding-top:7px;">
						<c:if test="${empty model.returnWeChatPay}">
							0.0
						</c:if>
						<c:if test="${not empty model.returnWeChatPay}">
							${model.returnWeChatPay }
						</c:if>
					</div>
				</div>
				<div class="form-group">
					<label for="product-uuid" class="col-xs-2 control-label">支付宝支付已退</label>
					<div class="col-xs-3" style="padding-top: 7px;">
						<c:if test="${empty model.returnAliPay}">
							0.0
						</c:if>
						<c:if test="${not empty model.returnAliPay}">
							${model.returnAliPay }
						</c:if>
					</div>
					
					<label for="product-uuid" class="col-xs-2 control-label">银行卡应退</label>
					<div class="col-xs-3" style="padding-top:7px;">
						<c:if test="${empty model.returnCard}">
							0.0
						</c:if>
						<c:if test="${not empty model.returnCard}">
							${model.returnCard }
						</c:if>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="product-uuid" class="col-xs-2 control-label">天和钱包已退</label>
					<div class="col-xs-3" style="padding-top:7px;">
						<c:if test="${empty model.returnTianhe}">
							0.0
						</c:if>
						<c:if test="${not empty model.returnTianhe}">
							${model.returnTianhe }
						</c:if>
					</div>
				
					<label for="product-uuid" class="col-xs-2 control-label">主订单号</label>
					<div class="col-xs-3" style="padding-top: 7px;">${model.order.code }</div>
				</div>
				...
				<div class="form-group">
					<label for="product-uuid" class="col-xs-12 control-label lantiao_lable">退货单金额统计</label>
				</div>
				
				<div class="form-group">
					<label for="product-uuid" class="col-xs-2 control-label" style="font-size: 22px;color: #0AA0D9">退货单金额</label>
					<div class="col-xs-2" style="padding-top: 7px;"><span style="font-size: 24px;color: red;">${model.sumMoney }</span>元</div>
					
					<label for="product-uuid" class="col-xs-2 control-label" style="font-size: 22px;color: #0AA0D9">退货单优惠总金额</label>
					<div class="col-xs-2" style="padding-top: 7px;"><span style="font-size: 24px;color: red;">${model.subMoney }</span>元</div>
					
					<label for="product-uuid" class="col-xs-2 control-label" style="font-size: 22px;color: #0AA0D9">退货单付款金额</label>
