...
/* 			body {
		...
		<table style="border:none;" class="print_title_font_size table table-striped table-hover table-bordered text-center" id="ggg" data-striped="true" data-smart-display="true">
			<thead class="text-center">
				<tr>
					...
					<th class="print_title_font_size" width="68%">名称</th>
					<th class="print_title_font_size" width="17%">售价</th>
				</tr>
			</thead>
			<tbody>
		...
		<div>
			<div class="print_title_font_size" style="width: 48%;display: inline-block;">总优惠:</div><span style="text-align: right;width: 50%;display: inline-block;" id="old_sumSubMoney">${model.subMoney }</span>
		</div>
		<div>
			<div class="print_title_font_size" style="width: 48%;display: inline-block;">优惠劵:</div><span style="text-align: right;width: 50%;display: inline-block;" id="old_sumSubMoney">${model.eticketMoney }</span>
		</div>
							...
							<tr>
								<td class="text-center" >
									<c:if test="${'3' eq orderGoods.orderSubremark.promotionLadder.promotion.type}">
										特价促销:满${orderGoods.orderSubremark.promotionLadder.ladderStart }元,返${orderGoods.orderSubremark.promotionLadder.promotionMoney }%
									</c:if>
		...
		<div>
			<div class="print_left print_title_font_size">付款金额:</div>
			<div class="print_right print_title_font_size" style="width: 60%"><span style="font-size: 22px;font-weight: bolder;">${model.payMoney }</span>元</div>
		</div>
		<div>
